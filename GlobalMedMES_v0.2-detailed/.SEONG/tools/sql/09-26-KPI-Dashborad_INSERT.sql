...
-- 설비 1
SET @produced_qty_1 = FLOOR(80 + RAND()*40);                      
SET @defect_qty_1   = FLOOR(@produced_qty_1 * (0.05 + RAND()*0.05)); 
...
-- 설비 2
SET @produced_qty_2 = FLOOR(100 + RAND()*50);
SET @defect_qty_2   = FLOOR(@produced_qty_2 * (0.08 + RAND()*0.12));
