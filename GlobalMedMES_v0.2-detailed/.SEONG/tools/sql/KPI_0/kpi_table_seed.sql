...
SET formula = '(good_qty.divide(total_qty, 4, T(java.math.RoundingMode).HALF_UP)).multiply(run_time.divide(planned_time, 4, T(java.math.RoundingMode).HALF_UP)).multiply(100)'
WHERE definition_name = 'OEE';
UPDATE tb_definition
SET formula = '(good_qty.divide(total_qty, 4, T(java.math.RoundingMode).HALF_UP)).multiply(100)'
WHERE definition_name = 'Yield';
UPDATE tb_definition
SET formula = '(defect_qty.divide(total_qty, 4, T(java.math.RoundingMode).HALF_UP)).multiply(100)'
WHERE definition_name = 'Defect Rate';
UPDATE tb_definition
SET formula = 'produced_qty.divide(run_time, 4, T(java.math.RoundingMode).HALF_UP)'
WHERE definition_name = 'Productivity';
